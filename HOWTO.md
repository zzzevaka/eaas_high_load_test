# Welcome to Connect Extension project High Load

## Next steps

You may open your favourite IDE and start working with your project, please note that this project runs using docker.
You may modify at any time the credentials used to authenticate to connect modifying the file *high_load/.high_load_dev.env*.
...
```sh
$ docker compose up high_load_dev
```
...
```sh
$ docker compose run high_load_bash
```
...
```sh
$ docker compose run high_load_test
```
